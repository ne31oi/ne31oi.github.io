    ...
    if (step < 9 && !active) {
        ...
        switch (step) {
            ...
            case 8:
                ...
                document.querySelector('#phones #phone2 #b').classList.remove('micro_hide');
                break;
        }
        timeActive(500);
        step++;
    ...
    if (step > 1 && !active) {
        switch (step) {
            ...
            case 9:
                ...
                document.querySelector('#phones #phone2 #b').classList.add('micro_hide');
                break;
