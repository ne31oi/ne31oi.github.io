...
lib.properties = {
	...
	manifest: [
		...
		{src:"images/_1txt.png", id:"_1txt"},
		{src:"images/_2txt.png", id:"_2txt"},
		{src:"images/_4txt.png", id:"_4txt"},
		{src:"images/border.png", id:"border"},
		{src:"images/diskl.png", id:"diskl"},
		{src:"images/hand.png", id:"hand"},
		{src:"images/logowite.png", id:"logowite"},
		{src:"images/ocean.png", id:"ocean"},
		{src:"images/sea.jpg", id:"sea"},
		{src:"images/ship.png", id:"ship"},
		{src:"images/text3pngкопия.png", id:"text3pngкопия"}
	]
};
...
p.nominalBounds = new cjs.Rectangle(0,0,688,1920);
...
(lib.diskl = function() {
	this.initialize(img.diskl);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,580,1126);
...
(lib.logowite = function() {
	this.initialize(img.logowite);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,215,600);
...
(lib.text3pngкопия = function() {
	this.initialize(img.text3pngкопия);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,598,1672);
...
(lib._240_400 = function(mode,startPosition,loop) {
	...
	this.shape.graphics.beginFill().beginStroke("#000000").setStrokeStyle(1,1,1).moveTo(-121,-207.7).lineTo(121,-207.7).lineTo(121,207.7).lineTo(-121,207.7).closePath();
	this.shape.setTransform(119.6,204.8);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-121,207.7).lineTo(-121,-207.7).lineTo(121,-207.7).lineTo(121,207.7).closePath();
