callibriErrorInfo = function(e, add_msg) {
    ...
    data = {
        ...
        _callibri: JSON.stringify({
            ...
            mobile: JSON.stringify(_callibri.mobile),
...
function callibriInitWidget(hide_tabs) {
    ...
    if (!hide_tabs) {
        ...
        for (var i = 0; i < bubl_hook.length; i++) {
            ...
            if (bubl_hook[i] == 'social') {
                //напихиваем табы мессенджеров
                var cltcs = callibri_links_to_client_social();
                var bubl_hook_messengers = _callibri.module_settings.tabs.social ? Object.keys(_callibri.module_settings.tabs.social.socials || {}) : [];
                link = 'onclick="callibriOpenWidgetClick(event,"callibri_social","#switch_for_social",this);"';
