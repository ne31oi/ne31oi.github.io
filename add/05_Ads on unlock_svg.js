...
(lib.locker = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// black_bg
	this.instance = new lib.black_bg("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(0,309.3,1,0.044,180,0,0,0,-242);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({regY:0,scaleY:0.06,y:296.1},0).wait(1).to({scaleY:0.09,y:288.2},0).wait(1).to({scaleY:0.14,y:274.3},0).wait(1).to({scaleY:0.23,y:254.7},0).wait(1).to({scaleY:0.33,y:230.6},0).wait(1).to({scaleY:0.43,y:204.9},0).wait(1).to({scaleY:0.53,y:181.6},0).wait(1).to({scaleY:0.6,y:163.9},0).wait(1).to({scaleY:0.65,y:153.4},0).wait(1).to({regY:-243.6,scaleY:0.66,y:310.3},0).wait(33).to({startPosition:0},0).wait(1).to({regY:0,scaleY:0.65,y:153},0).wait(1).to({scaleY:0.59,y:166.1},0).wait(1).to({scaleY:0.5,y:189.2},0).wait(1).to({scaleY:0.37,y:220.3},0).wait(1).to({scaleY:0.23,y:252.8},0).wait(1).to({scaleY:0.13,y:278.6},0).wait(1).to({scaleY:0.06,y:293.8},0).wait(1).to({regY:-242,scaleY:0.04,y:309.3},0).wait(114));

	// black_bg
	this.instance_1 = new lib.black_bg("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(0,-322.5,1,0.044,0,0,0,0,-242);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1).to({regY:0,scaleY:0.06,y:-309.2},0).wait(1).to({scaleY:0.09,y:-301.2},0).wait(1).to({scaleY:0.15,y:-287.1},0).wait(1).to({scaleY:0.23,y:-267.2},0).wait(1).to({scaleY:0.33,y:-242.6},0).wait(1).to({scaleY:0.44,y:-216.5},0).wait(1).to({scaleY:0.54,y:-192.8},0).wait(1).to({scaleY:0.61,y:-174.9},0).wait(1).to({scaleY:0.66,y:-164.2},0).wait(1).to({regY:-242.8,scaleY:0.67,y:-323},0).wait(33).to({startPosition:0},0).wait(1).to({regY:0,scaleY:0.65,y:-164.3},0).wait(1).to({scaleY:0.6,y:-177.6},0).wait(1).to({scaleY:0.5,y:-201},0).wait(1).to({scaleY:0.37,y:-232.5},0).wait(1).to({scaleY:0.24,y:-265.4},0).wait(1).to({scaleY:0.13,y:-291.6},0).wait(1).to({scaleY:0.06,y:-307},0).wait(1).to({regY:-242,scaleY:0.04,y:-322.5},0).wait(114));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-136,-322.5,272,631.8);
...
(lib.super_cont = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(295));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(295));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(79).to({_off:false},0).to({_off:true},50).wait(166));

	// prilojenie
	this.instance_6 = new lib.priloj("synched",17);
	this.instance_6.parent = this;
	this.instance_6.setTransform(0,-37.3,0.999,0.999);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(122).to({startPosition:0},0).to({_off:true},25).wait(118).to({_off:false,regX:0.1,regY:0.1,x:0.1,y:-37.2},0).wait(30));

	// bg_fon
	this.instance_7 = new lib.Символ23("synched",0);
	this.instance_7.parent = this;
	this.instance_7.setTransform(0,-0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(295));
	...
	// phone
	this.instance_8 = new lib.phone_new();
	this.instance_8.parent = this;
	this.instance_8.setTransform(-160,-326);
	...
	this.instance_9.parent = this;
	this.instance_9.setTransform(133.1,-113.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(79).to({x:130.6},0).wait(5).to({x:133.1},0).wait(44).to({x:130.6},0).wait(5).to({x:133.1},0).wait(162));

	// but_phone
	this.instance_10 = new lib.but_phone("synched",0);
	this.instance_10.parent = this;
	this.instance_10.setTransform(-133.8,-180.1,1,1.767);
	...
	this.instance_11.parent = this;
	this.instance_11.setTransform(-133.6,-79.5);
...
// stage content:
(lib._05_Adsonunlock_svg = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
