...
(lib.Символ87 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#006633").s().p("AhGBHQgdgdAAgqQAAgpAdgdQAdgdApAAQApAAAdAdQAeAdAAApQAAAqgeAdQgdAdgpAAQgpAAgdgdg");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-10,-10,20,20.1);
...
(lib.Символ71dcsdsd = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#009B4E").s().p("A1PDgIAAm/MAqfAAAIAAG/g");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ71dcsdsd, new cjs.Rectangle(-136,-22.4,272,44.8), null);
...
(lib.Символ17 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#006633").s().p("");
	this.shape.setTransform(0,-11.9);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-105.9,-334.2,211.9,668.5);
...
(lib.Символ14 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#999999").s().p("A1UC1IAAlpMAqpAAAIAAFpg");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-136.5,-18,273,36.1);
...
(lib.Символ15 = function(mode,startPosition,loop) {
	...
	// Символ 87
	this.instance = new lib.Символ87("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(70.3,320.1);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(317));

	// Символ 87
	this.instance_1 = new lib.Символ87("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(70.3,270);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(74).to({startPosition:0},0).wait(1).to({x:82.7},0).wait(1).to({x:89.7},0).wait(1).to({x:93.1},0).wait(1).to({x:94.1},0).wait(239));

	// Символ 87
	this.instance_2 = new lib.Символ87("synched",0);
	this.instance_2.parent = this;
	this.instance_2.setTransform(70.3,220);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(317));

	// Символ 87
	this.instance_3 = new lib.Символ87("synched",0);
	this.instance_3.parent = this;
	this.instance_3.setTransform(70.2,164.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(317));

	// Символ 87
	this.instance_4 = new lib.Символ87("synched",0);
	this.instance_4.parent = this;
	this.instance_4.setTransform(70.3,114.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(317));

	// Символ 87
	this.instance_5 = new lib.Символ87("synched",0);
	this.instance_5.parent = this;
	this.instance_5.setTransform(93.3,64.7);
	this.instance_5.filters = [new cjs.ColorFilter(0, 0, 0, 1, 0, 55, 28, 0)];
	this.instance_5.cache(-12,-12,24,24);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(317));

	// Символ 87
	this.instance_6 = new lib.Символ87("synched",0);
	this.instance_6.parent = this;
	this.instance_6.setTransform(70.3,19);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(317));

	// Символ 87
	this.instance_7 = new lib.Символ87("synched",0);
	this.instance_7.parent = this;
	this.instance_7.setTransform(70.3,-31);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(317));

	// Символ 87
	this.instance_8 = new lib.Символ87("synched",0);
	this.instance_8.parent = this;
	this.instance_8.setTransform(70.3,-81);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(15).to({startPosition:0},0).wait(1).to({x:84.1},0).wait(1).to({x:90.6},0).wait(1).to({x:93.4},0).wait(1).to({x:94.1},0).wait(298));

	// Символ 87
	this.instance_9 = new lib.Символ87("synched",0);
	this.instance_9.parent = this;
	this.instance_9.setTransform(93.4,-136.3);
	this.instance_9.filters = [new cjs.ColorFilter(0, 0, 0, 1, 0, 55, 28, 0)];
	this.instance_9.cache(-12,-12,24,24);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(317));

	// Символ 87
	this.instance_10 = new lib.Символ87("synched",0);
	this.instance_10.parent = this;
	this.instance_10.setTransform(93.3,-186.3);
	this.instance_10.filters = [new cjs.ColorFilter(0, 0, 0, 1, 0, 55, 28, 0)];
	this.instance_10.cache(-12,-12,24,24);

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(317));

	// Символ 87
	this.instance_11 = new lib.Символ87("synched",0);
	this.instance_11.parent = this;
	this.instance_11.setTransform(69.6,-236.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(317));

	// Слой 3
	this.instance_12 = new lib.Символ17("synched",0);
	this.instance_12.parent = this;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(317));
...
(lib.priloj = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(224));
	...
	this.instance_3.filters = [new cjs.ColorFilter(0, 0, 0, 1, 0, 155, 78, 0)];
	this.instance_3.cache(-138,-24,276,49);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(75).to({_off:false},0).wait(105).to({startPosition:0},0).wait(1).to({regY:0,x:74.5,y:-219.6},0).wait(1).to({x:134.1},0).wait(1).to({x:180.7},0).wait(1).to({x:216},0).wait(1).to({x:242},0).wait(1).to({x:260.1},0).wait(1).to({x:271.7},0).wait(1).to({x:278.1},0).wait(1).to({regY:-22.4,x:280,y:-242},0).to({_off:true},1).wait(34));

	// MASK+++++++ (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_75 = new cjs.Graphics().p("AxucSQhbAAhBhBQhAhAAAhcMAAAhQcQAAhbBAhAQBBhBBbAAMAjdAAAQBbAABBBBQBABAAABbMAAABQcQAABchABAQhBBBhbAAg");
	var mask_graphics_76 = new cjs.Graphics().p("EgRuAoEQhbAAhBhAQhAhBAAhbMAAAhQcQAAhcBAhAQBBhBBbAAMAjdAAAQBbAABBBBQBABAAABcMAAABQcQAABbhABBQhBBAhbAAg");
	var mask_graphics_77 = new cjs.Graphics().p("EgRuArrQhbAAhBhAQhAhBAAhcMAAAhQcQAAhbBAhAQBBhBBbAAMAjdAAAQBbAABBBBQBABAAABbMAAABQcQAABchABBQhBBAhbAAg");
	var mask_graphics_78 = new cjs.Graphics().p("EgRuArrQhbAAhBhAQhAhBAAhbMAAAhQcQAAhcBAhBQBBhABbAAMAjdAAAQBbAABBBAQBABBAABcMAAABQcQAABbhABBQhBBAhbAAg");
	var mask_graphics_79 = new cjs.Graphics().p("EgRuArrQhbAAhBhBQhAhAAAhbMAAAhQcQAAhcBAhBQBBhABbAAMAjdAAAQBbAABBBAQBABBAABcMAAABQcQAABbhABAQhBBBhbAAg");
	var mask_graphics_80 = new cjs.Graphics().p("EgRuArrQhbAAhBhAQhAhBAAhcMAAAhQcQAAhbBAhAQBBhBBbAAMAjdAAAQBbAABBBBQBABAAABbMAAABQcQAABchABBQhBBAhbAAg");
	var mask_graphics_81 = new cjs.Graphics().p("EgRuArrQhbAAhBhAQhAhBAAhcMAAAhQcQAAhbBAhAQBBhBBbAAMAjdAAAQBbAABBBBQBABAAABbMAAABQcQAABchABBQhBBAhbAAg");
	var mask_graphics_82 = new cjs.Graphics().p("EgRuArrQhbAAhBhAQhAhBAAhcMAAAhQcQAAhbBAhAQBBhBBbAAMAjdAAAQBbAABBBBQBABAAABbMAAABQcQAABchABBQhBBAhbAAg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(75).to({graphics:mask_graphics_75,x:0,y:-378}).wait(1).to({graphics:mask_graphics_76,x:0,y:-302.6}).wait(1).to({graphics:mask_graphics_77,x:0,y:-205}).wait(1).to({graphics:mask_graphics_78,x:0,y:-111.8}).wait(1).to({graphics:mask_graphics_79,x:0,y:-43.3}).wait(1).to({graphics:mask_graphics_80,x:0,y:2.9}).wait(1).to({graphics:mask_graphics_81,x:0,y:29.2}).wait(1).to({graphics:mask_graphics_82,x:0,y:37.5}).wait(108).to({graphics:null,x:0,y:0}).wait(34));

	// Слой 25
	this.instance_4 = new lib.Символ14("synched",0);
	this.instance_4.parent = this;
	this.instance_4.setTransform(0,341.5);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(75).to({_off:false},0).wait(1).to({y:325.7},0).wait(1).to({y:314.4},0).wait(1).to({y:306.9},0).wait(1).to({y:302.8},0).wait(1).to({y:301.5},0).wait(100).to({startPosition:0},0).wait(1).to({x:74.8},0).wait(1).to({x:134.8},0).wait(1).to({x:181.6},0).wait(1).to({x:217.1},0).wait(1).to({x:243.2},0).wait(1).to({x:261.4},0).wait(1).to({x:273.1},0).wait(1).to({x:279.5},0).wait(1).to({x:281.4},0).to({_off:true},1).wait(34));

	// Символ 89
	this.instance_5 = new lib.Символ15("synched",0);
	this.instance_5.parent = this;
	this.instance_5.setTransform(-0.3,236.4);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(75).to({_off:false},0).wait(1).to({y:218.7,startPosition:1},0).wait(1).to({y:204.7,startPosition:2},0).wait(1).to({y:193.8,startPosition:3},0).wait(1).to({y:185.8,startPosition:4},0).wait(1).to({y:180.4,startPosition:5},0).wait(1).to({y:177.3,startPosition:6},0).wait(1).to({y:176.4,startPosition:5},0).wait(10).to({startPosition:15},0).wait(34).to({startPosition:49},0).wait(1).to({y:140.6,startPosition:50},0).wait(1).to({y:109.5,startPosition:51},0).wait(1).to({y:82.2,startPosition:52},0).wait(1).to({y:58.4,startPosition:53},0).wait(1).to({y:37.5,startPosition:54},0).wait(1).to({y:19.2,startPosition:55},0).wait(1).to({y:3.3,startPosition:56},0).wait(1).to({y:-10.4,startPosition:57},0).wait(1).to({y:-22.2,startPosition:58},0).wait(1).to({y:-32.1,startPosition:59},0).wait(1).to({y:-40.5,startPosition:60},0).wait(1).to({y:-47.3,startPosition:61},0).wait(1).to({y:-52.6,startPosition:62},0).wait(1).to({y:-56.7,startPosition:63},0).wait(1).to({y:-59.5,startPosition:64},0).wait(1).to({y:-61.1,startPosition:65},0).wait(1).to({y:-61.6,startPosition:57},0).wait(37).to({startPosition:111},0).wait(1).to({x:74.5,startPosition:112},0).wait(1).to({x:134.5,startPosition:113},0).wait(1).to({x:181.3,startPosition:114},0).wait(1).to({x:216.8,startPosition:115},0).wait(1).to({x:242.9,startPosition:116},0).wait(1).to({x:261.1,startPosition:117},0).wait(1).to({x:272.8,startPosition:118},0).wait(1).to({x:279.2,startPosition:119},0).wait(1).to({x:281.1,startPosition:120},0).to({_off:true},1).wait(34));

	// podlojka
	this.instance_6 = new lib.Символ71("synched",0);
	this.instance_6.parent = this;
	this.instance_6.setTransform(0,-242,1,1,0,0,0,0,-22.4);
	this.instance_6.filters = [new cjs.ColorFilter(0, 0, 0, 1, 0, 55, 28, 0)];
	this.instance_6.cache(-138,-24,276,49);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(224));

	// podlojka
	this.instance_7 = new lib.Символ71dcsdsd("synched",0);
	this.instance_7.parent = this;
	this.instance_7.setTransform(0,-242,1,1,0,0,0,0,-22.4);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(75).to({_off:false},0).wait(1).to({regY:0,scaleY:4.39,y:-141.4},0).wait(1).to({scaleY:7.1,y:-78.9},0).wait(1).to({scaleY:9.2,y:-30.6},0).wait(1).to({scaleY:10.74,y:4.9},0).wait(1).to({scaleY:11.78,y:28.9},0).wait(1).to({scaleY:12.37,y:42.5},0).wait(1).to({regY:-21.7,scaleY:12.56,y:-233.8},0).wait(98).to({startPosition:0},0).wait(1).to({regY:0,x:74.9,y:38.7},0).wait(1).to({x:134.8},0).wait(1).to({x:181.6},0).wait(1).to({x:217.2},0).wait(1).to({x:243.2},0).wait(1).to({x:261.4},0).wait(1).to({x:273.1},0).wait(1).to({x:279.5},0).wait(1).to({regX:0.1,regY:-21.7,x:281.5,y:-233.8},0).to({_off:true},1).wait(34));

	// podlojka
	this.instance_8 = new lib.ten_your_app("synched",0);
	this.instance_8.parent = this;
	this.instance_8.setTransform(0,-215.4);
	this.instance_8.alpha = 0.199;
	this.instance_8.filters = [new cjs.ColorFilter(0, 0, 0, 1, 255, 255, 255, 0)];
	this.instance_8.cache(-138,-24,276,49);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(224));

	// Символ 7
	this.instance_9 = new lib.Символ9("synched",0);
	this.instance_9.parent = this;
	this.instance_9.setTransform(260,-57.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(39).to({startPosition:0},0).wait(1).to({x:371},0).wait(1).to({x:451.1},0).wait(1).to({x:507.6},0).wait(1).to({x:544.7},0).wait(1).to({x:565.5},0).wait(1).to({x:572},0).wait(179));

	// Символ 7
	this.instance_10 = new lib.Символ10("synched",0);
	this.instance_10.parent = this;
	this.instance_10.setTransform(-310,-57.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(39).to({startPosition:0},0).wait(1).to({x:-199},0).wait(1).to({x:-118.9},0).wait(1).to({x:-62.4},0).wait(1).to({x:-25.3},0).wait(1).to({x:-4.5},0).wait(1).to({x:2},0).wait(179));

	// Символ 7
	this.instance_11 = new lib.Символ8_1("synched",0);
	this.instance_11.parent = this;
	this.instance_11.setTransform(0,-142.7);
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(7).to({_off:false},0).wait(1).to({y:-139.7},0).wait(1).to({y:-128.6},0).wait(1).to({y:-105.8},0).wait(1).to({y:-75.5},0).wait(1).to({y:-58.9},0).wait(1).to({y:-58.2},0).wait(1).to({y:-60.4},0).wait(1).to({y:-62.9},0).wait(1).to({startPosition:0},0).wait(1).to({y:-57.7},0).wait(22).to({startPosition:0},0).wait(1).to({x:111},0).wait(1).to({x:191.1},0).wait(1).to({x:247.6},0).wait(1).to({x:284.7},0).wait(1).to({x:305.5},0).wait(1).to({x:312},0).wait(179));

	// podlojka
	this.instance_12 = new lib.Символ78("synched",0);
	this.instance_12.parent = this;
	this.instance_12.setTransform(0,-241.8,1,1.012,0,0,0,0,-98.8);
	this.instance_12.alpha = 0;
	this.instance_12._off = true;
	this.instance_12.filters = [new cjs.ColorFilter(0, 0, 0, 1, 0, 155, 78, 0)];
	this.instance_12.cache(-138,-101,276,202);

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(5).to({_off:false},0).wait(1).to({regY:0,scaleY:1.03,y:-139.8,alpha:0.036},0).wait(1).to({scaleY:1.11,y:-132.6,alpha:0.166},0).wait(1).to({scaleY:1.25,y:-117.7,alpha:0.434},0).wait(1).to({scaleY:1.46,y:-98,alpha:0.79},0).wait(1).to({scaleY:1.57,y:-87.1,alpha:0.986},0).wait(1).to({scaleY:1.57,y:-86.6,alpha:0.995},0).wait(1).to({scaleY:1.56,y:-88.1,alpha:0.968},0).wait(1).to({scaleY:1.54,y:-89.7,alpha:0.938},0).wait(1).to({startPosition:0},0).wait(1).to({regY:-98.8,scaleY:1.57,y:-241.8,alpha:1},0).wait(209));

	// Символ 124
	this.instance_13 = new lib.Символ124("synched",0);
	this.instance_13.parent = this;
	this.instance_13.setTransform(0,84.2);
	this.instance_13._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(7).to({_off:false},0).wait(1).to({regX:1.9,regY:2.3,x:1.9,y:88.3},0).wait(1).to({y:94.9},0).wait(1).to({y:108.6},0).wait(1).to({y:126.7},0).wait(1).to({y:136.7},0).wait(1).to({y:137.2},0).wait(1).to({y:135.8},0).wait(1).to({y:134.3},0).wait(1).to({startPosition:0},0).wait(1).to({regX:0,regY:0,x:0,y:135.2},0).wait(207));

	// Символ 123
	this.instance_14 = new lib.Символ123("synched",0);
	this.instance_14.parent = this;
	this.instance_14.setTransform(0,146.4);
	this.instance_14._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(5).to({_off:false},0).wait(1).to({regX:1.7,regY:2.2,x:1.7,y:150.4},0).wait(1).to({y:157.1},0).wait(1).to({y:170.7},0).wait(1).to({y:188.9},0).wait(1).to({y:198.9},0).wait(1).to({y:199.3},0).wait(1).to({y:198},0).wait(1).to({y:196.5},0).wait(1).to({startPosition:0},0).wait(1).to({regX:0,regY:0,x:0,y:197.4},0).wait(51).to({regX:-0.1,regY:0.2,scaleX:1.11,scaleY:1.11,x:-0.1,y:197.6},0).wait(5).to({regX:0,regY:0,scaleX:1,scaleY:1,x:0,y:197.4},0).wait(153));

	// bg
	this.instance_15 = new lib.bg_rabstol("synched",0);
	this.instance_15.parent = this;
	this.instance_15.setTransform(0,-242,1,1.16,0,0,0,0,-242);

	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(224));
...
(lib.super_cont = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(7).to({_off:false},0).wait(1).to({y:147},0).wait(1).to({y:89.3},0).wait(1).to({y:44.8},0).wait(1).to({y:10.4},0).wait(1).to({y:-15.6},0).wait(1).to({y:-34.7},0).wait(1).to({y:-47.6},0).wait(1).to({y:-55},0).wait(1).to({y:-57.4},0).wait(3).to({regX:0.1,scaleX:0.49,scaleY:0.49},0).wait(3).to({startPosition:0},0).to({regX:0.2,regY:0.1,x:121.5,y:-57.3},1).wait(16).to({scaleX:0.68,scaleY:0.68,x:121.6,y:-57.4},0).wait(1).to({regX:0,regY:0,x:68.1,y:37.4},0).wait(1).to({x:34.9,y:96.5},0).wait(1).to({x:14.5,y:132.8},0).wait(1).to({x:3.4,y:152.5},0).wait(1).to({regX:0.2,regY:0.1,x:0.2,y:158.6},0).wait(5).to({regX:0.3,regY:0.2,scaleX:0.49,scaleY:0.49,x:0.1,y:158.7},0).wait(5).to({regX:0.4,scaleX:0.68,scaleY:0.68,x:0.2},0).wait(13).to({startPosition:0},0).wait(1).to({regX:0,regY:0,x:30.7,y:114.5},0).wait(1).to({x:49.8,y:87},0).wait(1).to({x:61.6,y:70.1},0).wait(1).to({x:68,y:61},0).wait(1).to({regX:0.4,regY:0.2,x:70.3,y:58.3},0).wait(3).to({regY:0.3,scaleX:0.49,scaleY:0.49,x:70.2},0).wait(2).to({regX:0.5,regY:0.4,scaleX:0.68,scaleY:0.68,x:70.3},0).wait(14).to({startPosition:0},0).wait(1).to({regX:0,regY:0,x:69.9,y:92.6},0).wait(1).to({y:120.2},0).wait(1).to({y:142.5},0).wait(1).to({y:160.6},0).wait(1).to({y:175.1},0).wait(1).to({y:186.8},0).wait(1).to({y:195.8},0).wait(1).to({y:202.5},0).wait(1).to({y:207.1},0).wait(1).to({y:209.8},0).wait(1).to({regX:0.5,regY:0.4,x:70.3,y:210.9},0).wait(3).to({regX:0.4,scaleX:0.49,scaleY:0.49,x:70.1,y:210.8},0).wait(4).to({startPosition:0},0).wait(1).to({regX:0,regY:0,scaleX:0.54,scaleY:0.54,x:69.9,y:172.5},0).wait(1).to({scaleX:0.59,scaleY:0.59,y:144.4},0).wait(1).to({scaleX:0.62,scaleY:0.62,y:123.3},0).wait(1).to({scaleX:0.64,scaleY:0.64,y:107.7},0).wait(1).to({scaleX:0.66,scaleY:0.66,y:96.4},0).wait(1).to({scaleX:0.67,scaleY:0.67,y:88.9},0).wait(1).to({scaleX:0.68,scaleY:0.68,y:84.6},0).wait(1).to({regX:0.5,regY:0.5,scaleX:0.68,scaleY:0.68,x:70.3,y:83.5},0).wait(17).to({startPosition:0},0).wait(1).to({regX:0,regY:0,x:69.9,y:116.6},0).wait(1).to({y:139.1},0).wait(1).to({y:154.3},0).wait(1).to({y:164.1},0).wait(1).to({y:169.5},0).wait(1).to({regX:0.5,regY:0.5,x:70.3,y:171.6},0).wait(3).to({regX:0.4,scaleX:0.49,scaleY:0.49,x:70.1,y:171.4},0).wait(3).to({regX:0.5,scaleX:0.68,scaleY:0.68,x:70.3,y:171.6},0).wait(7).to({startPosition:0},0).wait(1).to({regX:0,regY:0,x:69.4,y:205.9},0).wait(1).to({x:69.1,y:229.2},0).wait(1).to({x:68.9,y:244.9},0).wait(1).to({x:68.8,y:255.1},0).wait(1).to({x:68.7,y:260.7},0).wait(1).to({regX:0.5,regY:0.5,x:69,y:262.9},0).wait(4).to({regY:0.4,scaleX:0.49,scaleY:0.49,x:68.9,y:262.7},0).to({_off:true},3).wait(167));

	// Слой 2
	this.instance_1 = new lib.anim_click("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(69,262.7,0.113,0.113,0,0,0,123.3,199.3);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(163).to({_off:false},0).to({_off:true},18).wait(152));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(333));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({_off:true},185).wait(118).to({_off:false,regX:0.1,regY:0.1,x:0.1,y:-37.2,startPosition:0},0).wait(30));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(333));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(333));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_10},{t:this.instance_9},{t:this.instance_8}]}).wait(333));
...
// stage content:
(lib._03_Adsonbackbutton_svg = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
