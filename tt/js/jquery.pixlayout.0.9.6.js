			...
			pixlayout : function (data, context) {
				...
				var show = function () {
					...
					$('.pxl_panel_wrap').hover(function () {
						if(!clip){
							$('.pxl_panel').fadeIn(200).animate({
								right: "0px"
							}, {queue:false,duration: 200});
						}
					}, function () {
						if(!clip){
							$('.pxl_panel').fadeOut(200).animate({
								right: "-134px"
							}, {queue:false,duration: 200});
						}
					});
